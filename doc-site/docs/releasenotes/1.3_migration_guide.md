...
[For an exact view of the changes to contract interfaces, see PR #1279.](https://github.com/hyperledger-firefly/firefly/pull/1279)
...
[For an exact view of the changes to contract APIs, see PR #1322.](https://github.com/hyperledger-firefly/firefly/pull/1322)
...
[For an exact view of the changes to token pools, see PR #1261.](https://github.com/hyperledger-firefly/firefly/pull/1261)
...
[For an exact view of the changes, see PR #1388.](https://github.com/hyperledger-firefly/firefly/pull/1388)
...
[For an exact view of the changes, see PR #1289](https://github.com/hyperledger-firefly/firefly/pull/1289).
...
[For an exact view of the changes, see PR #1305](https://github.com/hyperledger-firefly/firefly/pull/1305).
...
[For an exact view of the changes, see PR #1345](https://github.com/hyperledger-firefly/firefly/pull/1345).

...
1. Compile and deploy an instance of the new FireFly contract (linked above) to your blockchain, using `ff deploy` or [a similar method](https://hyperledger-firefly.github.io/firefly/tutorials/custom_contracts/ethereum.html#contract-deployment).

...
import (
	...
	shareddownload "github.com/hyperledger/firefly/internal/shareddownload"
)
...
// SharedDownload provides a mock function with given fields:
func (_m *Orchestrator) SharedDownload() shareddownload.Manager {
	ret := _m.Called()

	if len(ret) == 0 {
		panic("no return value specified for SharedDownload")
	}

	var r0 shareddownload.Manager
	if rf, ok := ret.Get(0).(func() shareddownload.Manager); ok {
		r0 = rf()
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(shareddownload.Manager)
		}
	}

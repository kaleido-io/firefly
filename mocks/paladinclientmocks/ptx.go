...
func (_m *PTX) Call(ctx context.Context, tx *pldapi.TransactionCall) (pldtypes.RawJSON, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *pldapi.TransactionCall) (pldtypes.RawJSON, error)); ok {
		return rf(ctx, tx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pldapi.TransactionCall) pldtypes.RawJSON); ok {
		r0 = rf(ctx, tx)
	} else {
		if ret.Get(0) != nil {
...
// CreateBlockchainEventListener provides a mock function with given fields: ctx, listener
func (_m *PTX) CreateBlockchainEventListener(ctx context.Context, listener *pldapi.BlockchainEventListener) (bool, error) {
	ret := _m.Called(ctx, listener)

	if len(ret) == 0 {
		panic("no return value specified for CreateBlockchainEventListener")
	}

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *pldapi.BlockchainEventListener) (bool, error)); ok {
		return rf(ctx, listener)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *pldapi.BlockchainEventListener) bool); ok {
		r0 = rf(ctx, listener)
	} else {
		r0 = ret.Get(0).(bool)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *pldapi.BlockchainEventListener) error); ok {
		r1 = rf(ctx, listener)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PTX) DecodeCall(ctx context.Context, callData pldtypes.HexBytes, dataFormat pldtypes.JSONFormatOptions) (*pldapi.ABIDecodedData, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, pldtypes.HexBytes, pldtypes.JSONFormatOptions) (*pldapi.ABIDecodedData, error)); ok {
		return rf(ctx, callData, dataFormat)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pldtypes.HexBytes, pldtypes.JSONFormatOptions) *pldapi.ABIDecodedData); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, pldtypes.HexBytes, pldtypes.JSONFormatOptions) error); ok {
...
func (_m *PTX) DecodeError(ctx context.Context, revertData pldtypes.HexBytes, dataFormat pldtypes.JSONFormatOptions) (*pldapi.ABIDecodedData, error) {
...
func (_m *PTX) DecodeEvent(ctx context.Context, topics []pldtypes.Bytes32, eventData pldtypes.HexBytes, dataFormat pldtypes.JSONFormatOptions) (*pldapi.ABIDecodedData, error) {
	...
	var r0 *pldapi.ABIDecodedData
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, []pldtypes.Bytes32, pldtypes.HexBytes, pldtypes.JSONFormatOptions) (*pldapi.ABIDecodedData, error)); ok {
		return rf(ctx, topics, eventData, dataFormat)
	}
	if rf, ok := ret.Get(0).(func(context.Context, []pldtypes.Bytes32, pldtypes.HexBytes, pldtypes.JSONFormatOptions) *pldapi.ABIDecodedData); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, []pldtypes.Bytes32, pldtypes.HexBytes, pldtypes.JSONFormatOptions) error); ok {
...
// DeleteBlockchainEventListener provides a mock function with given fields: ctx, listenerName
func (_m *PTX) DeleteBlockchainEventListener(ctx context.Context, listenerName string) (bool, error) {
	ret := _m.Called(ctx, listenerName)

	if len(ret) == 0 {
		panic("no return value specified for DeleteBlockchainEventListener")
	}
...
// GetBlockchainEventListener provides a mock function with given fields: ctx, listenerName
func (_m *PTX) GetBlockchainEventListener(ctx context.Context, listenerName string) (*pldapi.BlockchainEventListener, error) {
	ret := _m.Called(ctx, listenerName)

	if len(ret) == 0 {
		panic("no return value specified for GetBlockchainEventListener")
	}

	var r0 *pldapi.BlockchainEventListener
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*pldapi.BlockchainEventListener, error)); ok {
		return rf(ctx, listenerName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *pldapi.BlockchainEventListener); ok {
		r0 = rf(ctx, listenerName)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pldapi.BlockchainEventListener)
		}
	}
...
// GetBlockchainEventListenerStatus provides a mock function with given fields: ctx, name
func (_m *PTX) GetBlockchainEventListenerStatus(ctx context.Context, name string) (*pldapi.BlockchainEventListenerStatus, error) {
	ret := _m.Called(ctx, name)

	if len(ret) == 0 {
		panic("no return value specified for GetBlockchainEventListenerStatus")
	}

	var r0 *pldapi.BlockchainEventListenerStatus
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (*pldapi.BlockchainEventListenerStatus, error)); ok {
		return rf(ctx, name)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) *pldapi.BlockchainEventListenerStatus); ok {
		r0 = rf(ctx, name)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*pldapi.BlockchainEventListenerStatus)
		}
	}
...
func (_m *PTX) GetDomainReceipt(ctx context.Context, domain string, txID uuid.UUID) (pldtypes.RawJSON, error) {
	...
	var r0 pldtypes.RawJSON
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, uuid.UUID) (pldtypes.RawJSON, error)); ok {
		return rf(ctx, domain, txID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, uuid.UUID) pldtypes.RawJSON); ok {
...
func (_m *PTX) GetStoredABI(ctx context.Context, hashRef pldtypes.Bytes32) (*pldapi.StoredABI, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, pldtypes.Bytes32) (*pldapi.StoredABI, error)); ok {
		return rf(ctx, hashRef)
	}
	if rf, ok := ret.Get(0).(func(context.Context, pldtypes.Bytes32) *pldapi.StoredABI); ok {
		r0 = rf(ctx, hashRef)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(context.Context, pldtypes.Bytes32) error); ok {
		r1 = rf(ctx, hashRef)
	} else {
		r1 = ret.Error(1)
	}
...
// QueryBlockchainEventListeners provides a mock function with given fields: ctx, jq
func (_m *PTX) QueryBlockchainEventListeners(ctx context.Context, jq *query.QueryJSON) ([]*pldapi.BlockchainEventListener, error) {
	ret := _m.Called(ctx, jq)

	if len(ret) == 0 {
		panic("no return value specified for QueryBlockchainEventListeners")
	}

	var r0 []*pldapi.BlockchainEventListener
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *query.QueryJSON) ([]*pldapi.BlockchainEventListener, error)); ok {
		return rf(ctx, jq)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *query.QueryJSON) []*pldapi.BlockchainEventListener); ok {
		r0 = rf(ctx, jq)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).([]*pldapi.BlockchainEventListener)
...
// StartBlockchainEventListener provides a mock function with given fields: ctx, listenerName
func (_m *PTX) StartBlockchainEventListener(ctx context.Context, listenerName string) (bool, error) {
	ret := _m.Called(ctx, listenerName)

	if len(ret) == 0 {
		panic("no return value specified for StartBlockchainEventListener")
	}
...
// StopBlockchainEventListener provides a mock function with given fields: ctx, listenerName
func (_m *PTX) StopBlockchainEventListener(ctx context.Context, listenerName string) (bool, error) {
	ret := _m.Called(ctx, listenerName)

	if len(ret) == 0 {
		panic("no return value specified for StopBlockchainEventListener")
	}
...
// SubscribeBlockchainEvents provides a mock function with given fields: ctx, listenerName
func (_m *PTX) SubscribeBlockchainEvents(ctx context.Context, listenerName string) (rpcclient.Subscription, error) {
	ret := _m.Called(ctx, listenerName)

	if len(ret) == 0 {
		panic("no return value specified for SubscribeBlockchainEvents")
	}
...
// UpdateTransaction provides a mock function with given fields: ctx, id, tx
func (_m *PTX) UpdateTransaction(ctx context.Context, id uuid.UUID, tx *pldapi.TransactionInput) (*uuid.UUID, error) {
	...
	var r0 *uuid.UUID
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *pldapi.TransactionInput) (*uuid.UUID, error)); ok {
		return rf(ctx, id, tx)
	}
	if rf, ok := ret.Get(0).(func(context.Context, uuid.UUID, *pldapi.TransactionInput) *uuid.UUID); ok {
		r0 = rf(ctx, id, tx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*uuid.UUID)
	...
	if rf, ok := ret.Get(1).(func(context.Context, uuid.UUID, *pldapi.TransactionInput) error); ok {
		r1 = rf(ctx, id, tx)
	} else {
		r1 = ret.Error(1)
	}

...
paladin:
		$(eval PALADINCLIENT_PATH := $(shell $(VGO) list -f '{{.Dir}}' github.com/kaleido-io/paladin/sdk/go/pkg/pldclient))
paladinrpc:
		$(eval PALADINRPCCLIENT_PATH := $(shell $(VGO) list -f '{{.Dir}}' github.com/kaleido-io/paladin/sdk/go/pkg/rpcclient))

define makemock
mocks: mocks-$(strip $(1))-$(strip $(2))
mocks-$(strip $(1))-$(strip $(2)): ${MOCKERY} ffcommon paladin paladinrpc
...
$(eval $(call makemock, internal/blockchain/common, BlockchainCallbacks,         blockchaincommonmocks))
...
$(eval $(call makemock, $$(PALADINCLIENT_PATH),     PaladinClient,               paladinclientmocks))
$(eval $(call makemock, $$(PALADINCLIENT_PATH),     PaladinWSClient,             paladinclientmocks))
$(eval $(call makemock, $$(PALADINCLIENT_PATH),     PTX,                         paladinclientmocks))
$(eval $(call makemock, $$(PALADINRPCCLIENT_PATH),  ErrorRPC,                    paladinrpcclientmocks))
$(eval $(call makemock, $$(PALADINRPCCLIENT_PATH),  RPCSubscriptionNotification, paladinrpcclientmocks))
$(eval $(call makemock, $$(PALADINRPCCLIENT_PATH),  Subscription,                paladinrpcclientmocks))

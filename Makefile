...
paladin:
		$(eval PALADINCLIENT_PATH := $(shell $(VGO) list -f '{{.Dir}}' github.com/kaleido-io/paladin/toolkit/pkg/pldclient))
paladinrpc:
		$(eval PALADINRPCCLIENT_PATH := $(shell $(VGO) list -f '{{.Dir}}' github.com/kaleido-io/paladin/toolkit/pkg/rpcclient))

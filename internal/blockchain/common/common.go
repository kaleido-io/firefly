...
// type EthLocation struct {
// 	Address string `json:"address"`
// }

// func (el *EthLocation) Encode(ctx context.Context) (result *fftypes.JSONAny, err error) {
// 	el.Address, err = FormatEthAddress(ctx, el.Address)
// 	if err != nil {
// 		return nil, err
// 	}
// 	normalized, err := json.Marshal(el)
// 	if err == nil {
...
// func ParseEthContractLocation(ctx context.Context, location *fftypes.JSONAny) (*EthLocation, error) {
// 	ethLocation := EthLocation{}

...
func (s *SQLCommon) GetDataPaths(ctx context.Context, namespace, parent string) (paths []string, res *ffapi.FilterResult, err error) {

	sq.Select("blob_name").From(dataTable).Where(sq.And{

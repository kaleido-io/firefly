...
var (
	...
	APIParamsParentPath                     = ffm("api.params.parentPath", "The parent path to query paths underneath of - optionally with a '/' prefix which is ignored")
	...
	APIEndpointsGetDataPaths                    = ffm("api.endpoints.getDataPaths", "Gets a paginated list of unique sub-paths of data names, when split with a '/' character, optionally below a given parent path. Excludes the last 'filename' part of the path")

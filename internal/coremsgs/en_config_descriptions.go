...
var (
	...
	ConfigPluginBlockchainPaladinRPCURL = ffc("config.plugins.blockchain[].paladin.rpc.url", "The URL of the JSON/RPC endpoint for the Paladin instance", i18n.StringType)
